...
template <std::string_view const &, typename, std::string_view const &,
          typename>
struct concat;
...
template <std::string_view const &S1, std::size_t... I1,
          std::string_view const &S2, std::size_t... I2>
...
struct join<S1, S2> {
  static constexpr std::string_view value =
      std::string_view(impl::concat<S1, std::make_index_sequence<S1.size()>, S2,
